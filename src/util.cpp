...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "corallium" is a composite category enabling all Corallium-related debug output
...
// Windows < Vista: C:\Documents and Settings\Username\Application Data\Corallium
// Windows >= Vista: C:\Users\Username\AppData\Roaming\Corallium
// Mac: ~/Library/Application Support/Corallium
// Unix: ~/.corallium
#ifdef WIN32
    // Windows
